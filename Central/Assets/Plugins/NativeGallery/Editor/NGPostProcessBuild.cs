...
public class NGPostProcessBuild
{
	...
	private const string PHOTO_LIBRARY_USAGE_DESCRIPTION = "Pixels can let you import custom lighting patterns from image files stored in your pictures, allow access if you want to use this feature.";
	private const string PHOTO_LIBRARY_ADDITIONS_USAGE_DESCRIPTION = "Pixels can let you import custom lighting patterns from image files stored in your pictures, allow access if you want to use this feature.";
